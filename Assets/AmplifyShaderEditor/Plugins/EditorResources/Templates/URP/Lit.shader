	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:LOD CrossFade:false,true:true
				true:SetDefine:Forward:pragma multi_compile_local _ LOD_FADE_CROSSFADE
				true:SetDefine:GBuffer:pragma multi_compile_local _ LOD_FADE_CROSSFADE
				true:SetDefine:ShadowCaster:pragma multi_compile_local _ LOD_FADE_CROSSFADE
				true:SetDefine:DepthOnly:pragma multi_compile_local _ LOD_FADE_CROSSFADE
				true:SetDefine:DepthNormals:pragma multi_compile_local _ LOD_FADE_CROSSFADE
				false:RemoveDefine:Forward:pragma multi_compile_local _ LOD_FADE_CROSSFADE
				false:RemoveDefine:GBuffer:pragma multi_compile_local _ LOD_FADE_CROSSFADE
				false:RemoveDefine:ShadowCaster:pragma multi_compile_local _ LOD_FADE_CROSSFADE
				false:RemoveDefine:DepthOnly:pragma multi_compile_local _ LOD_FADE_CROSSFADE
				false:RemoveDefine:DepthNormals:pragma multi_compile_local _ LOD_FADE_CROSSFADE
		...
		*/
		...
		Pass
		{
			...
			struct Attributes
			{
				...
				#endif
				/*ase_vdata:p=p;n=n;t=t;uv0=tc0;uv1=tc1*/
				UNITY_VERTEX_INPUT_INSTANCE_ID
			};
			...
			struct PackedVaryings
			{
				...
				#endif
				/*ase_interp(5,):sp=sp;wp=tc0.xyz;wn.xyz=tc1.xyz;wt=tc2*/
				UNITY_VERTEX_INPUT_INSTANCE_ID
				UNITY_VERTEX_OUTPUT_STEREO
			};
		...
		Pass
		{
			...
			struct PackedVaryings
			{
				...
				float4 lightmapUVOrVertexSH : TEXCOORD3;
					...
					half4 fogFactorAndVertexLight : TEXCOORD4;
				#endif
				/*ase_interp(5,):sp=sp;wp=tc0.xyz;wn.xyz=tc1.xyz;wt.xyz=tc2.xyz*/
				UNITY_VERTEX_INPUT_INSTANCE_ID
				UNITY_VERTEX_OUTPUT_STEREO
			};
